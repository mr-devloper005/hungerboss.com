      ...
      <form onSubmit={submit} className="mt-6 rounded-[var(--tk-radius)] border border-[var(--tk-line)] bg-[var(--tk-surface)] p-5">
        ...
        <div className="mt-3 flex justify-end">
          <button
            type="submit"
            disabled={!text.trim()}
            className="inline-flex items-center gap-2 rounded-full bg-[var(--tk-accent)] px-6 py-2.5 text-sm font-semibold text-[var(--tk-on-accent)] transition hover:brightness-[0.94] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
          >
