...
export const taskPageVoices = {
  ...
  pdf: {
    ...
    headline: 'Download-ready references, kept as a working library.',
    description: 'A shelf of guides, reports, and reference files you can preview and download — not another article feed.',
  ...
  listing: {
    ...
    headline: 'Local businesses built for discovery and comparison.',
    description: 'A working directory of places near you with trust cues, contact details, and a practical search rhythm.',
    filterLabel: 'Filter business category',
    secondaryNote: 'Prioritize comparison, location, and direct action paths.',
    chips: ['Nearby', 'Compare', 'Contact direct'],
  },
  image: {
