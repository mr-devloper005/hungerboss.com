export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'hungerboss',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Hungerboss',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'hungerboss.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://hungerboss.com',
